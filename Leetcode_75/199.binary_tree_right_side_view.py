...
arr1 : list = [1,2,3,None,5,None,4]
arr2 : list = [1,2,3,4,None,None,None,5]
arr3 : list = [1,None,3]
arr4 : list = []
...
tree4 : TreeNode = insertLevelOrder(arr4, 0, len(arr4))

solution : Solution = Solution()
print(solution.rightSideView(tree1)) # [1,3,4]
print(solution.rightSideView(tree2)) # [1,3,4,5]
print(solution.rightSideView(tree3)) # [1,3]
print(solution.rightSideView(tree4)) # []